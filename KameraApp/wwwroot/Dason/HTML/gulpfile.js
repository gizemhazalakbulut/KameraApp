...
const paths = {
  ...
  dist:   {
    ...
    libs:   {
      dir:    './dist//Dason/HTML/dist/assets/libs'
    },
    css:    {
      dir:    './dist//Dason/HTML/dist/assets/css',
    },
    js:    {
      dir:    './dist//Dason/HTML/dist/assets/js',
      files:  './dist//Dason/HTML/dist/assets/js/pages',
    },
  },
  src:    {
    base:   {
    ...
    css:    {
      dir:    './src//Dason/HTML/dist/assets/css',
      files:  './src//Dason/HTML/dist/assets/css/**/*'
    },
    html:   {
      dir:    './src',
      files:  './src/**/*.html',
    ...
    img:    {
      dir:    './src//Dason/HTML/dist/assets/images',
      files:  './src//Dason/HTML/dist/assets/images/**/*',
    },
    js:     {
      dir:    './src//Dason/HTML/dist/assets/js',
      pages:  './src//Dason/HTML/dist/assets/js/pages',
      files:  './src//Dason/HTML/dist/assets/js/pages/*.js',
      main:   './src//Dason/HTML/dist/assets/js/*.js',
    },
    partials:   {
      dir:    './src/partials',
      files:  './src/partials/**/*'
    ...
    scss:   {
      dir:    './src//Dason/HTML/dist/assets/scss',
      files:  './src//Dason/HTML/dist/assets/scss/**/*',
      main:   './src//Dason/HTML/dist/assets/scss/*.scss'
    }
  }
};
...
gulp.task('html', function() {
  return gulp
    ...
    .pipe(replace(/href="(.{0,10})node_modules/g, 'href="$1/Dason/HTML/dist/assets/libs'))
    .pipe(replace(/src="(.{0,10})node_modules/g, 'src="$1/Dason/HTML/dist/assets/libs'))
    .pipe(useref())
    .pipe(cached())

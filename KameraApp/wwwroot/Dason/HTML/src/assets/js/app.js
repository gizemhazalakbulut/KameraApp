...
(function ($) {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "/Dason/HTML/dist/assets/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "/Dason/HTML/dist/assets/images/flags/spain.jpg";
            } else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "/Dason/HTML/dist/assets/images/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "/Dason/HTML/dist/assets/images/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "/Dason/HTML/dist/assets/images/flags/russia.jpg";
            }
    ...
    function getLanguage() {
        ...
        $.getJSON('/Dason/HTML/dist/assets/lang/' + language + '.json', function (lang) {
    ...
    function layoutSetting() {
        ...
        $("input[name='layout-direction']").on('change', function () {
            if ($(this).val() == "ltr") {
                ...
                document.getElementById('bootstrap-style').setAttribute('href', '/Dason/HTML/dist/assets/css/bootstrap.min.css');
                document.getElementById('app-style').setAttribute('href', '/Dason/HTML/dist/assets/css/app.min.css');
            } else {
                document.getElementById('bootstrap-style').setAttribute('href', '/Dason/HTML/dist/assets/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', '/Dason/HTML/dist/assets/css/app-rtl.min.css');
